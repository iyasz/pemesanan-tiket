                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{old("name")}}" name="name" class="form-control fs-s-sm @error("name") is-invalid @enderror">
                                @error("name") <p class="fs-s-sm mb-0 fw-300 text-danger">{{$message}}</p> @enderror
                           </div>
                            <div class="mb-3">
                                <label class="mb-1 fs-s-sm opacity-75">Email</label>
                                <input type="text" value="{{old("email")}}" name="email" class="form-control fs-s-sm @error("email") is-invalid @enderror">
                                @error("email") <p class="fs-s-sm mb-0 fw-300 text-danger">{{$message}}</p> @enderror
                           </div>
                            <div class="mb-3">
                                <label class="mb-1 fs-s-sm opacity-75">Username</label>
                                <input type="text" value="{{old("username")}}" name="username" class="form-control fs-s-sm @error("username") is-invalid @enderror">
